...
export const currentBooking: CurrentBooking = {
  ...
  experiences: [
    { id: 'e1', name: "Chef's Table (8 pax)", date: 'May 16', status: 'Pending' },
    { id: 'e2', name: 'Pool Exclusive — Sunset', date: 'May 17', status: 'Pending' },
    { id: 'e3', name: 'Wine Vault Tasting', date: 'May 19', status: 'Complimentary' },
    { id: 'e4', name: 'Surf Lesson (4 pax)', date: 'May 20', status: 'Confirmed' },
  ],
