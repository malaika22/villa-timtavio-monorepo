...
/**
 * Establish the session an access token represents.
 *
 * Every way into the app ends here — the magic link, a typed code, and the
 * Auth0 code exchange — so all three produce identical state. They differ only
 * in how they obtain the token.
 */
