...
export const FilterChips = ({
  ...
  return (
    <div className="no-scrollbar -mx-3 flex snap-x gap-2 overflow-x-auto px-3 pb-1 [-webkit-mask-image:linear-gradient(to_right,#000_0,#000_calc(100%-1.5rem),transparent)] [mask-image:linear-gradient(to_right,#000_0,#000_calc(100%-1.5rem),transparent)]">
      {chips.map((chip) => {
